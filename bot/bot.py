...
V0_HEADLINE = (
    ...
    # This headline cannot repost because deployed includes_v0 is permanently 1.
    "• The in-game overlay renders the verdict card and is bundled with the app.\n"
    '• "Open details" now shows which mods actually drove the delta.'
)
OVERLAY_HEADLINE = (
    "**The in-game overlay is now in the download.**\n"
    "The previous note said the download did not include the overlay. That is no "
    "longer true. It starts automatically with `run.bat`; press **Ctrl+Alt+D** "
    "to show it. Set `OVERLAY_HOTKEY` to override the hotkey, or use "
