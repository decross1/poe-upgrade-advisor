...
- **Linux runtime is not hermetic.** Upstream vendors Windows LuaJIT and native
  modules. A user-local source build pinned to LuaJIT
  `a471ab78c7b670b4f92dae111fc3c96fb824c768` and lua-utf8
  `08b0fc930f5a52eff36348ed1ea39aadfc697fa6` now runs the integration suite,
  but packaging those dependencies for CI is still required before release.
